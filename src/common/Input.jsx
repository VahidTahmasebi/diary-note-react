  ...
  return (
    <div className='lg:w-2/12 flex flex-col justify-between'>
      ...
      <input
        ...
        className='w-full p-2 text-main-black rounded-xl outline-none shadow-lg focus:ring-1 focus:ring-offset-1 focus:ring-indigo-200 transition ease-in duration-200'
      />
